...
LANGFUSE_PUBLIC_KEY = "pk-lf-ce52cf74-d349-4dbd-9e84-57d13f447853"
LANGFUSE_SECRET_KEY = "sk-lf-f587d2b2-ab95-454a-b81f-7bcd865ecb5f"
LANGFUSE_HOST = "http://langfuse:3000"

# Get current date/time in Europe/Madrid timezone
tz = pytz.timezone('Europe/Madrid')
now = datetime.now(tz)
current_date = now.strftime("%Y-%m-%d")  # e.g., "2025-11-29"
